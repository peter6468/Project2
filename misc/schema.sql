...
VALUES  ( 1, 'Makes List', 'Relies On Memory', FALSE, current_timestamp(), current_timestamp()),
    ( 2, 'Skeptical', 'Wants To Believe', TRUE, current_timestamp(), current_timestamp()),
    ...
    ( 1, 'Keeps A Clean Room', 'Just Puts Stuff Wherever', FALSE, current_timestamp(), current_timestamp()),
    ( 2, 'Prefers Things Done Manually', 'Prefers Things Done Automatically', FALSE, current_timestamp(), current_timestamp()),
    ( 3, 'Energetic', 'Mellow', TRUE, current_timestamp(), current_timestamp()),
    ( 4, 'Prefers To Take Multiple Choice Exam', 'Prefers To Take An Essay Exam', FALSE, current_timestamp(), current_timestamp()),
    ...
    ( 1, 'Plans In Advance', 'Plans At The Last Minute', FALSE, current_timestamp(), current_timestamp()),
    ( 2, 'Wants Respect from Others', 'Wants Their Love', TRUE, current_timestamp(), current_timestamp()),
    ...
    ( 3, 'Talks More', 'Listens More', TRUE, current_timestamp(), current_timestamp()),
    ...
    ( 1, 'Finishes Work Right Away', 'Procrastinates', FALSE, current_timestamp(), current_timestamp()),
    ( 2, 'Follows The Heart', 'Follows The Head', FALSE, current_timestamp(), current_timestamp()),
    ( 3, 'Stays At Home', 'Goes Out', FALSE, current_timestamp(), current_timestamp()),
    ...
    ( 2, 'Uncomfortable With Emotions', 'Values Emotions', TRUE, current_timestamp(), current_timestamp()),
